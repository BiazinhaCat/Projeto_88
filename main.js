...
function loadImg(){
	...
	newImage();
	 ...
	 //fica dentro da função loadImg, entre as linhas 27 e 29 (na linha 28) 
...
function myKeyDown(e)
{
	...
	function right(){
		...
		if(ballX <= 1050)
		{
			ballX = ballX + blockImageWidth; //não seria X? Para a direita usa x 
			console.log("Largura do Bloco = " + blockImageWidth); //não seria width? X é largura, usa o width
	...
	function left()
	{
		if(ballX > 5)
		{
			...
			console.log("Largura do Bloco = " + blockImageWidth); //a largura não seria width?
